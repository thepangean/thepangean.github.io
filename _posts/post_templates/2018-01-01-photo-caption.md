...
<div class="caption" style="text-align: left"><a href="javascript:void(0)" target="_blank"><img src="assets/images/{{ site.baseurl }}{{ page.pic1 }}" style="width:100%"/></a><b>Country:</b> Italy <br>
